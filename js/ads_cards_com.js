...
document.addEventListener('DOMContentLoaded', function() {
    const ads = JSON.parse(localStorage.getItem("company_ads")) || [];
    const allAdsContainer = document.getElementById('allAds');
        ...
        ads.forEach((ad, index) => {
            ...
            adCard.innerHTML = `
                ...
                <div class="ad-content">
                    ...
                    <div class="ad-company">${ad.companyName} - ${ad.companyField}</div>
...
function applyToAd(adIndex) {
    ...
    let ownerLink = ad.companyEmail.includes("company") ? `company.html?email=${currentUser.email}` : `people_dashboard.html?email=${currentUser.email}`;
